...
import { Grid, Header, Radio, Button, Segment } from 'semantic-ui-react'
...
class ConversionOptions extends Component {
  ...
  render() {
    console.log("ConversionOptions:", this.props, this.state)
...
export default connect(mapStateToProps, { saveRecipe, setConversionUnit })(ConversionOptions)
